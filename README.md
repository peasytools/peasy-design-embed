...
[![npm](https://img.shields.io/npm/v/peasy-design-embed)](https://www.npmjs.com/package/peasy-design-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-design-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-design-embed)

Embed **PeasyDesign** widgets on any website or blog. Design tools — color palettes, gradients, shadows, and typography. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-design` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyDesign is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasydesign.com](https://widget.peasydesign.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-design-embed demo -- embed peasydesign widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
<div data-peasy-design="tool"
  data-slug="color-palette"
  data-theme="light">
</div>

<!-- 2. Load the embed script once, anywhere on the page -->
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
```

That's it. The script will find all `data-peasy-design` elements, fetch data from the PeasyDesign API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyDesign supports 11 widget types -- 11 common types available on all Peasy sites.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-design="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-design="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-design="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-design="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-design="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-design="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-design="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-design="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-design="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-design="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-design="interactive" data-slug="..."></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-design` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive | *required* | Widget type to render |
...
<div data-peasy-design="tool" data-slug="color-palette" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-design="tool" data-slug="color-palette" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-design="tool" data-slug="color-palette" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-design="tool" data-slug="color-palette" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#D946EF`) is consistent across all themes, providing brand recognition for PeasyDesign.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyDesign format info card with light theme -->
<div data-peasy-design="format" data-slug="color-palette" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyDesign tools and formats -->
<div data-peasy-design="search"
  data-placeholder="Search PeasyDesign tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-design="badge" data-slug="color-palette"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Embed an interactive PeasyDesign tool -->
<div data-peasy-design="interactive"
  data-slug="design/example-tool"
  data-height="500"
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
...
> **Note:** The `data-slug` value uses the format `category-slug/tool-slug`. Find available tools at [peasydesign.com/api/v1/tools/](https://peasydesign.com/api/v1/tools/).
...
```html
<div data-peasy-design="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyDesign API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyDesign" backlink in the footer

## Learn More

Visit [peasydesign.com](https://peasydesign.com) for the full PeasyDesign experience.

- **All Tools**: [peasydesign.com](https://peasydesign.com)
- **Formats**: [peasydesign.com/formats/](https://peasydesign.com/formats/)
- **Glossary**: [peasydesign.com/glossary/](https://peasydesign.com/glossary/)
- **Guides**: [peasydesign.com/guides/](https://peasydesign.com/guides/)
- **API Documentation**: [peasydesign.com/developers/](https://peasydesign.com/developers/)
- **OpenAPI Spec**: [peasydesign.com/api/openapi.json](https://peasydesign.com/api/openapi.json)
- **Widget Builder**: [widget.peasydesign.com](https://widget.peasydesign.com)
- **npm Package**: [npmjs.com/package/peasy-design-embed](https://www.npmjs.com/package/peasy-design-embed)
...
Embed [PeasyDesign](https://peasydesign.com) widgets on any website with [peasy-design-embed](https://widget.peasydesign.com):

```html
<script src="https://cdn.jsdelivr.net/npm/peasy-design-embed@1/dist/embed.min.js"></script>
<div data-peasydesign="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.peasydesign.com)
